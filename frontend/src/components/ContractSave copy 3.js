...
const ContractSave = (props) => {
  ...
  const [selectedPjtNo, setSelectedPjtNo] = useState("");
  const [selectedCompanyNo, setSelectedCompanyNo] = useState("");
  ...
  const companyList = () => {
    let url = "http://localhost/contract/compmayList";
  ...
  const setPjtNo = (e) => {
    console.log("setSelectedPjtNo==>", e.value);
    setSelectedPjtNo(e.value);
  }

  const setCompanyNo = (e) => {
    console.log("setSelectedCompanyNo==>", e.value);
    setSelectedCompanyNo(e.value);
  }
        ...
        <tbody>
          <tr>
            ...
            <td align="left" className="input-100-L">
              <select onChange={setPjtNo} value={selectedPjtNo} >
                {project.map((item) => (
            ...
            <td align="left" className="input-100-L">
              <select onChange={setCompanyNo} value={selectedCompanyNo} >
                {company.map((item) => (
                  <option value={item.companyNo} key={item.companyNo}>
